        ...
        Expanded(
          child: Scaffold(
            appBar: AppBar(
              ...
              centerTitle: false,
              actions: const <Widget>[PopButton(), AboutIconButton()],
...
class _MenuItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color iconColor = enabled
        ? isLight
            ? Color.alphaBlend(
                theme.colorScheme.primary.withAlpha(0x99), theme.colorScheme.onSurface)
            : Color.alphaBlend(
                theme.colorScheme.primary.withAlpha(0x7F), theme.colorScheme.onSurface)
                    ...
                    child: Row(
                      children: <Widget>[
                        MaybeTooltip(
                          ...
                          condition:
                              (width == railWidth || label != tooltip) && tooltip != '' && enabled,
